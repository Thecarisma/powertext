 ...
 */
package com.power.text.pteditor.parser;
...
import com.power.text.io.DocumentReader;
...
/*
	public static void main(String[] args) {
		...
		power.text.rsyntaxtextarea.RSyntaxTextArea textArea = new
			power.text.rsyntaxtextarea.RSyntaxTextArea(25, 40);
		...
		frame.setContentPane(new power.text.rtextarea.RTextScrollPane(textArea));
		frame.pack();
