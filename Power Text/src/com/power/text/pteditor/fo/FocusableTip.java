 ...
 */
package com.power.text.pteditor.fo;

import com.power.text.ui.pteditor.PopupWindowDecorator;
...
public class FocusableTip {
	...
	//private static final ResourceBundle MSdG = ResourceBundle.getBundle("com.power.text.pteditor.fo.FocusableTip");
