...
import com.power.text.pteditor.fo.TipUtil;
...
class ClipboardHistoryPopup extends JWindow {
	...
	ClipboardHistoryPopup(Window parent, RTextArea textArea) {
		...
		cp.setBorder(BorderFactory.createCompoundBorder(com.power.text.pteditor.fo.TipUtil.getToolTipBorder(),
				BorderFactory.createEmptyBorder(2, 5, 5, 5)));
		cp.setBackground(com.power.text.pteditor.fo.TipUtil.getToolTipBackground());
		setContentPane(cp);
