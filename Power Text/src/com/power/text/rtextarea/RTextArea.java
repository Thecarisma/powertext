...
import com.power.text.print.RPrintUtilities;
import com.power.text.rtextarea.Macro.MacroRecord;
...
public class RTextArea extends RTextAreaBase implements Printable {
	...
	public static RecordableTextAction undoAction;
	public static RecordableTextAction redoAction;
	...
	private static final String MSG	= "com.power.text.rtextarea.RTextArea";
	...
	public static synchronized void beginRecordingMacro() {
		...
		JOptionPane.showMessageDialog(null, "Now recording a macro");
	...
	protected void configurePopupMenu(JPopupMenu popupMenu) {
		...
		if (undoMenuItem!=null) {
			...
			redoMenuItem.setEnabled(redoAction.isEnabled() && canType);
                        Tundo.setEnabled(undoAction.isEnabled() && canType);
                        Tredo.setEnabled(redoAction.isEnabled() && canType);
                        Undo.setEnabled(undoAction.isEnabled() && canType);
                        redo.setEnabled(redoAction.isEnabled() && canType);
	...
	public void read(Reader in, Object desc) throws IOException {
                    try {
                            ...
                            Logger.getLogger(RTextArea.class.getName()).log(Level.SEVERE, null, ex);
                        }
